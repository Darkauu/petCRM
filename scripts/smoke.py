...
def run_flow(db_path):
    ...
    print("\nBorrado logico")
    check("archivar cliente", client.post("/clientes/1/archivar").status_code == 302)
    check("el cliente archivado deja de ser alcanzable",
          client.get("/clientes/1").status_code == 404)
